...
for (group_name in groups) {
  subset_seurat <- subset(merged_seurat_fat, subset = group == group_name)
...
saveRDS(cellchat_list,file = "cellchat_list.fat.RDS")

#other process
cellchat.fat$HFD_KO = computeCommunProbPathway(cellchat.fat$HFD_KO, thresh = 0.05)
cellchat.fat$HFD_WT = computeCommunProbPathway(cellchat.fat$HFD_WT, thresh = 0.05)
cellchat.fat$ND_KO = computeCommunProbPathway(cellchat.fat$ND_KO, thresh = 0.05)
cellchat.fat$HFD_KO <- aggregateNet(cellchat.fat$HFD_KO)
cellchat.fat$HFD_WT <- aggregateNet(cellchat.fat$HFD_WT)
cellchat.fat$ND_KO <- aggregateNet(cellchat.fat$ND_KO)
cellchat.fat$HFD_KO <- netAnalysis_computeCentrality(cellchat.fat$HFD_KO, slot.name = "netP")
cellchat.fat$HFD_WT <- netAnalysis_computeCentrality(cellchat.fat$HFD_WT, slot.name = "netP")
cellchat.fat$ND_KO <- netAnalysis_computeCentrality(cellchat.fat$ND_KO, slot.name = "netP")

#save csv results
df.net.HFD_KO <- subsetCommunication(cellchat.fat$HFD_KO)
df.netp.HFD_KO <- subsetCommunication(cellchat.fat$HFD_KO, slot.name = "netP")
write.csv(df.net.HFD_KO,file="df.net.HFD_KO.csv")
write.csv(df.netp.HFD_KO,file="df.netp.HFD_KO.csv")

df.net.HFD_WT <- subsetCommunication(cellchat.fat$HFD_WT)
df.netp.HFD_WT <- subsetCommunication(cellchat.fat$HFD_WT, slot.name = "netP")
write.csv(df.net.HFD_WT,file="df.net.HFD_WT.csv")
write.csv(df.netp.HFD_WT,file="df.netp.HFD_WT.csv")

df.net.ND_KO <- subsetCommunication(cellchat.fat$ND_KO)
df.netp.ND_KO <- subsetCommunication(cellchat.fat$ND_KO, slot.name = "netP")
write.csv(df.net.ND_KO,file="df.net.ND_KO.csv")
write.csv(df.netp.ND_KO,file="df.netp.ND_KO.csv")



##############fat cell chat all in one
object.list <- list(
  HFD_KO = cellchat.fat$HFD_KO,
  HFD_WT = cellchat.fat$HFD_WT,
  ND_KO = cellchat.fat$ND_KO
)
...
library(CellChat)
pdf(file="fat.mac.detailLR.HFDKO.NDKO.pdf",width=16,height=6)
...
pdf(file="fat.mac.detailLR.HFDKO.HFDWT.pdf",width=16,height=6)
...
###
library(CellChat)
pdf(file="fat.mac.detailLR.HFDKO.NDKO1.pdf",width=8,height=6)
gg1 <- netAnalysis_signalingChanges_scatter(cellchat.merged, idents.use = "Macrophage",comparison = c(3,1))
gg1 + scale_color_manual(values = rep("black", 4)) +
  scale_shape_manual(values = rep(21, 4))
dev.off()

pdf(file="fat.mac.detailLR.HFDKO.HFDWT1.pdf",width=8,height=6)
gg1 <- netAnalysis_signalingChanges_scatter(cellchat.merged, idents.use = "Macrophage",comparison = c(2,1))
gg1 + scale_color_manual(values = rep("black", 4)) +
  scale_shape_manual(values = rep(21, 4))
dev.off()
...
#######number
pdf(file="fat.compareInteractions.pdf",width=6,height=4)
...
pdf(file="fat.netVisual_diffInteraction.hfdko.ndko.pdf",width=12,height=12)
...
pdf(file="fat.netVisual_diffInteraction.hfdko.hfdwt.pdf",width=12,height=12)
par(mfrow = c(1,2), xpd=TRUE)
...
####
# ʾ??ϸ??????
fat.groups <- levels(object.list[[1]]@idents)
# ????????3????ɫ
mypal_cellchat.fat <- mypal_3[1:length(fat.groups)]
# ?????????ֵ???ɫ??��
cols_named <- setNames(mypal_cellchat.fat,fat.groups)

# ?????б??ｻ??????ʹ??
col_list <- list(fat.groups = cols_named)


pdf(file="fat.netVisual_diffInteraction.heatmap.hfdko.ndko.pdf",width=12,height=6)
...
pdf(file="fat.netVisual_diffInteraction.heatmap.hfdko.hfdwt.pdf",width=12,height=6)
...
###only strength
pdf(file="fat.netVisual_diffInteraction.heatmap.hfdko.ndko.strength.pdf",width=7,height=6)
gg2 <- netVisual_heatmap(cellchat.merged,comparison = c("ND_KO","HFD_KO"), measure = "weight",color.use = cols_named)
gg2
dev.off()

pdf(file="fat.netVisual_diffInteraction.heatmap.hfdko.hfdwt.strength.pdf",width=7,height=6)
gg2 <- netVisual_heatmap(cellchat.merged,comparison = c("HFD_WT","HFD_KO"), measure = "weight",color.use = cols_named)
gg2
dev.off()
...
pdf(file="fat.netVisual_diffInteraction.numbers.circleplot.pdf",width=18,height=6)
...
pdf(file="fat.netVisual_diffInteraction.weights.circleplot.pdf",width=18,height=6)
par(mfrow = c(1,3), xpd=TRUE)
for (i in 1:length(object.list)) {
...
pdf(file="fat.netAnalysis_signalingRole_scatter.pdf",width=12,height=4)
...
# pdf(file="fat.netAnalysis_signalingChanges_scatter.macrophage.pdf",width=8,height=4)
...
# dev.off()
# 
# pdf(file="fat.netAnalysis_signalingChanges_scatter.macrophage.pdf",width=12,height=6)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.Macrophage.out.pdf",width=12,height=12)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.Macrophage.in.pdf",width=12,height=12)
...
DC
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.DC.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.DC.in.pdf",width=12,height=18)
...
####B
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.B.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.B.in.pdf",width=12,height=18)
...
####T
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.T.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.T.in.pdf",width=12,height=18)
...
#############################
######hfd ko hfd wt
pdf(file="fat.netVisual_bubble.hfdko.ndko.Macrophage.out.pdf",width=12,height=12)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.Macrophage.in.pdf",width=12,height=12)
...
####DC
pdf(file="fat.netVisual_bubble.hfdko.ndko.DC.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.DC.in.pdf",width=12,height=18)
...
####B
pdf(file="fat.netVisual_bubble.hfdko.ndko.B.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.B.in.pdf",width=12,height=18)
...
####T
pdf(file="fat.netVisual_bubble.hfdko.ndko.T.out.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.T.in.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.Macrophage.out.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.Macrophage.in.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.B.in.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.B.out.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.T.in.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.T.out.sigdif.pdf",width=12,height=18)
...
###DC
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.DC.in.sigdif.pdf",width=12,height=18)
...
pairLR.use.up = net.up.HFD_KO.ND_KO[, "interaction_name", drop = F]
pdf(file="fat.netVisual_bubble.hfdko.ndko.DC.out.sigdif.pdf",width=12,height=18)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.cxcl.sigdif.pdf",width=12,height=4)
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.cxcl.sigdif.pdf",width=12,height=4)
...
pdf(file="fat.netVisual_bubble.all.cxcl.sigdif.pdf",width=8,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(1,2, 3),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
gg1
dev.off()
...
#####
pdf(file="fat.netVisual_bubble.allgroup.cxcl.all.sigdif.pdf",width=13,height=6)
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.tnf.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(3, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.tnf.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(2, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.Il6.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(3, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.Il6.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(2, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
pdf(file="fat.netVisual_bubble.hfdko.ndko.cxcl.Il6.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(3, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
pdf(file="fat.netVisual_bubble.hfdko.hfdwt.cxcl.Il6.sigdif.pdf",width=12,height=4)
gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(2, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
#> Comparing communications on a merged object
pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
gg1
...
gg2 <- n# etVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.down, sources.use = c(1:9), targets.use = c(1:9) , comparison = c(3, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Down-regulated signaling in ", names(object.list)[1]))
# #> Comparing communications on a merged object
# gg1 + gg2
# )
...
pdf(file="fat.netVisual_aggregate.IFN2.pdf",width=12,height=4)
...
pdf(file="fat.netVisual_aggregate.TGFb.pdf",width=12,height=4)
...
pdf(file="fat.netVisual_aggregate.CXCL.pdf",width=12,height=4)
...
pdf(file="fat.netVisual_aggregate.CCL.pdf",width=12,height=4)
pathways.show <- c("CCL") 
weight.max <- getMaxWeight(object.list, slot.name = c("netP"), attribute = pathways.show) # control the edge weights across different datasets
par(mfrow = c(1,2), xpd=TRUE)
for (i in 1:length(object.list)) {
...
pdf(file="fat.netVisual_aggregate.TNF.pdf",width=12,height=4)
pathways.show <- c("TNF") 
weight.max <- getMaxWeight(object.list, slot.name = c("netP"), attribute = pathways.show) # control the edge weights across different datasets
par(mfrow = c(1,2), xpd=TRUE)
for (i in 1:length(object.list)) {
...
pdf(file="fat.netVisual_aggregate.TNFlr.pdf",width=12,height=4)
pathways.show <- c("TNF") 
weight.max <- getMaxWeight(object.list, slot.name = c("netP"), attribute = pathways.show) # control the edge weights across different datasets
par(mfrow = c(1,2), xpd=TRUE)
for (i in 1:length(object.list)) {
...
pdf(file="fat.netVisual_aggregate.IL6.pdf",width=12,height=4)
pathways.show <- c("IL6") 
weight.max <- getMaxWeight(object.list, slot.name = c("netP"), attribute = pathways.show) # control the edge weights across different datasets
par(mfrow = c(1,2), xpd=TRUE)
for (i in 1:length(object.list)) {
...
pdf(file# pdf(file="fat.netVisual_aggregate.IFN2.heatmap.pdf",width=12,height=4)
# pathways.show <- c("IFN-II"), 
# par(mfrow = c(1,2), xpd=TRUE)
# ht <- list()
# for (i in 1:length(object.list)) {
...
# pathways.show <- c("CXCL")
# pdf(file="fat.Chord.diagram.cxcl.sigdif.pdf",width=12,height=4)
# par(mfrow = c(1,2), xpd=TRUE)
# for (i in 1:length(object.list)) {
...
# pairLR.use.up = pairLR.use.up[, "interaction_name", drop = F]
# 
# pdf(file="fat.netVisual_bubble.hfdko.ndko.il1.sigdif.pdf",width=12,height=4)
# gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(3, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
# #> Comparing communications on a merged object
# pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
# gg1
# dev.off()
# 
# pdf(file="fat.netVisual_bubble.hfdko.hfdwt.il1.sigdif.pdf",width=12,height=4)
# gg1 <- netVisual_bubble(cellchat.merged, pairLR.use = pairLR.use.up, sources.use = c(1:9), targets.use = c(1:9), comparison = c(2, 1),  angle.x = 90, remove.isolate = T,title.name = paste0("Up-regulated signaling in ", names(object.list)[1]))
# #> Comparing communications on a merged object
# pairLR.use.down = net.down.HFD_KO.ND_KO[, "interaction_name", drop = F]
# gg1
