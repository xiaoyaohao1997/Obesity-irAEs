...
######################################################################################
merged_seurat_fat=readRDS("merged_seurat_adipose.rds")
...
pdf(file="fat.mac.detailLR.HFDKO.NDKO.pdf",width=8,height=6)
...
pdf(file="fat.mac.detailLR.HFDKO.HFDWT.pdf",width=8,height=6)
